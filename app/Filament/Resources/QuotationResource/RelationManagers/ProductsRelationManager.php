...
class ProductsRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Productos de la cotización';
        ...
        return $table
            ...
            ->headerActions([
                ...
                CreateAction::make('add_existing')
                    ...
                    ->visible(fn(): bool => auth()->user()->can('quotations.details.attach'))
                    ->modalHeading('Añadir recurso existente a la cotización')
                    ->form($this->schema())
                    ->action(function (array $data, $livewire) {
            ...
            ->actions([
                EditAction::make()
                    ->visible(fn(): bool => auth()->user()->can('quotations.details.edit.view'))
                    ...
                    ->action(function (Model $record, array $data): void {
                        ...
                        if (!auth()->user()->can('quotations.details.edit')) {
                            Notification::make()
                ...
                RefreshTotalDeleteAction::make()
                    ->visible(fn(): bool => auth()->user()->can('quotations.details.delete')),
            ])
            ->bulkActions([
                BulkActionGroup::make([
                    DeleteBulkAction::make()
                        ->visible(fn(): bool => auth()->user()->can('quotations.details.bulk_delete')),
                ]),
            ]);
    }
    ...
    {
        return auth()->user()->can('quotations.details.view');
    }
